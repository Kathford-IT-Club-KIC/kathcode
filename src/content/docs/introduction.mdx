...
Kathford College of Engineering and Management is excited to announce the upcoming three-day hackathon program, Kathcode, scheduled for the 20th to 22nd of Bhadra within the college premises. A hackathon is an intensive event where participants collaborate to innovate over a few days. The hackathon will then be followed by a post-event pitching session where participants will present their ideas to the track sponsors and showcase their project as a solution to a real-life problem. The Shark-Tank style pitching session will be held on the 23rd of Bhadra, 2082
