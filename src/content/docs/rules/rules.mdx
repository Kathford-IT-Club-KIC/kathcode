...
2. All team members must be currently enrolled undergraduate students.
...
5. Participating teams are required to submit a registration fee of Rs 2000 during the registration process.
6. All team and other members are required to stay overnight and are not allowed to leave the premises.
7. All teams must be present before `8:00 am on the 7th Asar (22 June, 2024, Friday)`.
