...
5. Participating teams are required to submit a registration fee of Rs 5000 once team is selected after initial selection round.
6. All team and other members are required to stay overnight and are not allowed to leave the premises.
7. All teams must be present before `8:00 am on the 20th Bhadra`.
